...
public class SolrUtil {
    ...
    static {
        // url = "http://127.0.0.1:8983/solr/jd_pro_spu";
        url = "http://47.94.252.198:8983/solr/yuemee_pro";
    ...
    public static QueryResponse queryMulti(SolrQuery query) throws SolrServerException, IOException {
        QueryResponse rsp = client.query(query);
        return rsp;
    }
